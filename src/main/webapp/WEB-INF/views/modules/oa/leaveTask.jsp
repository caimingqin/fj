	...
	<script type="text/template" id="reportBackTemplate">
		<table class="table table-striped ">
			...
			<tr>
				<td>实际开始时间：</td>
				<td>
					<input id="realityStartTime" readonly="true" maxlength="20" class=" Wdate required"
			...
			<tr>
				<td>实际结束时间：</td>
				<td>
					<input id="realityEndTime" readonly="true" maxlength="20" class=" Wdate required" 
							onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',isShowClear:false});"/>
				</td>
			</tr>
		</table>
	...
	<script type="text/template" id="modifyApplyTemplate">
		<table class="table table-striped " id="modifyApplyContent">
			...
			<tr>
				<td>请假<font color="red">开始</font>时间：</td>
				<td>
					<input id="startTime" name="startTime" type="text" readonly="true" maxlength="20" class=" Wdate required"
			...
			<tr>
				<td>请假<font color="red">结束</font>时间：</td>
				<td>
					<input id="endTime" name="endTime" type="text" readonly="true" maxlength="20" class=" Wdate required"

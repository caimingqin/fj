...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/house/contract/">合同列表</a></li>
		<li class="active"><a href="${ctx}/house/contract/form?id=${contract.id}">合同<shiro:hasPermission name="house:contract:edit">${not empty contract.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="house:contract:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>

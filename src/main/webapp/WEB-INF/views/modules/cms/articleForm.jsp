	...
	<form:form id="inputForm" modelAttribute="article" action="${ctx}/cms/article/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				&nbsp;过期时间：
				<input id="weightDate" name="weightDate" type="text" readonly="true" maxlength="20" class="input-small Wdate"
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="createDate" name="createDate" type="text" readonly="true" maxlength="20" class="input-medium Wdate"
